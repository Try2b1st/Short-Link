...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    @Insert("INSERT INTO t_link_access_stats (" +
            ...
            "VALUES (" +
            "#{linkAccessStats.fullShortUrl}, #{linkAccessStats.gid}, #{linkAccessStats.date}, #{linkAccessStats.pv}, #{linkAccessStats.uv}, #{linkAccessStats.uip}, #{linkAccessStats.our}, #{linkAccessStats.weekday}, NOW(), NOW()) " +
